...
export default function TicketCollection({ team }: TicketCollectionProps) {
  ...
  useEffect(() => {
    ...
    setTickets(savedTickets.filter((ticket: FanTicket) => ticket.team === team.id))
  }, [team.id])

  const getTicketIcon = (type: string) => {
    return type === "attendance" ? <MapPin className="w-4 h-4" /> : <Tv className="w-4 h-4" />
  }
        ...
        <Card>
          <CardContent>
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 mb-4">경기를 보고 직관 티켓이나 TV 시청 티켓을 발급받아보세요!</p>
            </div>
          </CardContent>
        </Card>
      ) : (
                  ...
                  >
                    ...
                    <div className="relative z-10 text-center">
                      ...
                      <div className="mb-3">
                        ...
                        <div className="font-bold text-lg tracking-wide">{teamDesign.nickname.toUpperCase()}</div>
                      ...
                      >
                        ...
                        {ticket.type === "attendance" ? "STADIUM" : "TV VIEWING"}
                      </div>
                      ...
                      <div className="space-y-2 mb-3">
                        ...
                        >
                          ...
                          <div className="font-bold text-xs">{ticket.stadium || "잠실야구장"}</div>
                        </div>
                      ...
                      {/* Serial Number */}
                      <div className="text-xs opacity-75 font-mono">#{ticket.id.toString().slice(-6)}</div>
                    </div>
